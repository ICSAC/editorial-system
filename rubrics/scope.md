...
**5** — Solid scientific methodology; work the panel can credibly evaluate
    (theory, computation, math, modeling, quantitative empirical work in
    domains where rigorous reasoning drives the conclusions).

**4** — Sound methodology; slight competence stretch for the panel
...
**3** — Methodology is sound but the panel cannot credibly evaluate
...
**1** — Out of scope: no scientific or formal methodology to evaluate.
...
## ICSAC's research programs (informational — not a scoring gate)
...
**1. Does this work use scientific, mathematical, computational, or formal
   ...
   If no → score 1. Do not proceed to question 2.

**2. Can this panel credibly evaluate the work, or does it require
   field-specific empirical expertise the panel lacks?**
   If credibly evaluable → score 4–5 based on rigor.
   If specialist-flagged → score 3. Note the specific competence gap
...
Do not double-penalize weak methodology here — that is what the
