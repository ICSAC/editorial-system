...
Subject: Your submission has been accepted to the ICSAC Community — {{paper_title}}
...
[Post to X]({{share_x_url}}) · [Share on LinkedIn]({{share_linkedin_url}}) · [Post to Facebook]({{share_fb_url}}) · [Post to Bluesky]({{share_bluesky_url}})
